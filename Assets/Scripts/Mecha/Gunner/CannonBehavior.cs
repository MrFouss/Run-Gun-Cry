...
public class CannonBehavior : MonoBehaviour {
    ...
    {
        FireRateLaser = (Mathf.Pow((-balanceValue) + 3.0f, 2.0f) / 5.0f) * BaseFireRateLaserValue;
        FireRateMissile = (Mathf.Pow((-balanceValue) + 3.0f, 2.0f) / 5.0f) * BaseFireRateMissileValue;
    }
